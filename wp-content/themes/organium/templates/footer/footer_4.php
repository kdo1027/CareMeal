...
<?php
    ...
    if (
        ...
        echo '<div class="organium_footer_bottom">';
            echo '<div class="container">';
                echo '<div class="organium_footer_columns">';
                ...
                if (
                    ...
                    echo '<div class="organium_footer_additional_menu_container column">';
                    if (
                        $footer_customize_additional_menu == 'yes' &&
                ...
                if (
                    ...
                    echo '<div class="organium_copyright_container column">';
                    if (
                        $footer_customize_copyright == 'yes' &&
                        !empty(organium_get_post_option('footer_copyright_text'))
                    ) {
                ...
                if (
                    ...
                    echo '<div class="organium_payment_container column">';
                    if (
                        $footer_customize_payment == 'yes' &&
                        organium_get_post_option('footer_payment_status') == 'show' &&
                        !empty(organium_get_post_option('footer_payment_image'))
