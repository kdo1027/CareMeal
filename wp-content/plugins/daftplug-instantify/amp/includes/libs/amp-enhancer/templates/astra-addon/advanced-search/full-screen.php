...
?>
<div hidden [hidden]="astSearch" class="ast-search-box full-screen" id="ast-seach-full-screen-form" style="display: block;opacity: 1;">
	<span id="close" class="close" on="tap:AMP.setState({ astSearch: true })"></span>
