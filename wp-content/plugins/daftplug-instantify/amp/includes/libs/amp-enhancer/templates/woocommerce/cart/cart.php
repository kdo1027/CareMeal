...
$submit_url =  admin_url('admin-ajax.php?action=amp_enhancer_cart_coupon_operation');
		...
		<tbody>
			...
			<tr>
				<td colspan="6" class="actions">
					...
					<button type="submit" class="button" name="amp_update_cart" value="<?php esc_attr_e( 'Update cart', 'woocommerce' ); ?>"><?php esc_html_e( 'Update cart', 'woocommerce' ); ?></button>
