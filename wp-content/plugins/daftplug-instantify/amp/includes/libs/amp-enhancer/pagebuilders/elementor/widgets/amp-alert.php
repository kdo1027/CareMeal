...
class AMP_Alert extends Widget_Base {
	...
	protected function render() {
		...
		if ( \Elementor\Utils::is_empty( $settings['alert_title'] ) ) {
			return;
		}
		...
		?>
		<div [hidden]="alert<?php esc_attr_e($id); ?>" <?php echo $this->get_render_attribute_string( 'wrapper' ); ?>>
			<span <?php echo $this->get_render_attribute_string( 'alert_title' ); ?>><?php echo esc_html($settings['alert_title']); ?></span>
			<?php
			if ( ! \Elementor\Utils::is_empty( $settings['alert_description'] ) ) :
				...
				?>
				<span <?php echo $this->get_render_attribute_string( 'alert_description' ); ?>><?php echo esc_html($settings['alert_description']); ?></span>
			<?php endif; ?>
			<?php if ( 'show' === $settings['show_dismiss'] ) : ?>
				<button type="button" class="elementor-alert-dismiss" on="tap:AMP.setState({alert<?php esc_attr_e($id); ?>: true})">
