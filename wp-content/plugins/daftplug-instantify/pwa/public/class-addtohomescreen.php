    ...
    class daftplugInstantifyPwaPublicAddtohomescreen {
        ...
        public function generateManifest() {
            ...
            if ($wp->request == self::$manifestName) {
                ...
                $this->manifest['start_url'] = (!empty($_GET['start_url']) ? $_GET['start_url'] : trailingslashit(daftplugInstantify::getSetting('pwaStartPage')));
        ...
        public function renderCheckoutOverlay() {
            if (daftplugInstantify::isAmpPage() || !daftplugInstantify::isWoocommerceActive()) {
                return;
            }
        ...
        public function renderPostOverlay() {
            if (daftplugInstantify::isAmpPage() || !is_single()) {
                return;
            }
        ...
        public function renderInstallationButton($atts) {
            if (daftplugInstantify::isAmpPage() || !wp_is_mobile() || daftplugInstantify::getSetting('pwaInstallButton') !== 'on') {
                return;
            }
