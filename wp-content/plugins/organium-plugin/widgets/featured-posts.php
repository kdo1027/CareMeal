...
if (!class_exists('organium_featured_posts_widget'))
{
    class organium_featured_posts_widget extends WP_Widget
    {
        public function __construct()
        {
            parent::__construct(
                'organium_featured_posts_widget',
                'Featured Posts (Organium Theme)',
                array('description' => esc_html__('Featured Posts Widget by Organium Theme', 'organium_plugin'))
            );
        }
        ...
        public function widget($args, $instance)
        {
            ...
            if (have_posts()) {
                echo '<div class="organium_featured_posts_widget_wrapper">';
                while (have_posts()) {
                    the_post();

                    echo '
                        <div class="recent-posts__item">
                            <div class="recent-posts__item-img">'  .get_the_post_thumbnail(null, array(75, 75)) . '</div>
